...
class FACTModel(nn.Module):
    ...
    def __init__(self, config, mask_index=-1, quant_factor=None):
        ...
        self.conditioning_mlp = ConditioningMLP(input_size=1, hidden_size=68, output_size=136)
        ...
        # self.post_projector = nn.Linear(dim, dim)
