...
class PIXIE(object):
    ...
    def decode(self, param_dict, param_type):
        ...
        # print("global pose",param_dict['global_pose'].shape)
        # print("head_pose",param_dict['head_pose'].shape)
        ...
        # param_dict['global_pose'] = torch.tensor([[[[ 0.9853, -0.1093,  0.1316],[-0.0964, -0.9902, -0.1009],[ 0.1414,  0.0867, -0.9862]]]], device='cuda:0')
        # param_dict['head_pose'] = torch.tensor([[[[ 0.7145, -0.0552,  0.6975], [-0.1646, -0.9822,  0.0909],[ 0.6800, -0.1797, -0.7108]]]], device='cuda:0')
        ...
        # param_dict['global_pose'] = torch.tensor([[2.1575,  0.0758,  0.1458, -1.9156, -0.1362,  0.2579]],device='cuda:0')
        # param_dict['head_pose'] = torch.tensor([[3.6232,  0.3233,  0.3945, -3.9940, -0.2013, -1.2070]],device='cuda:0')
        ...
        # cam = torch.tensor([[2.7187, -0.0148, 0.7362]], device='cuda:0')
